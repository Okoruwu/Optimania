	...
	if($nombre==""){
		...
		if($caractCount[0]['total']<10000){
			...
			if($insert){
				...
				header('location:/admin/nuevo/caracteristica');//exito
				exit;
			}else{
                setcookie("msg","ups",time() + 2, "/");
				header('location:/admin/nuevo/caracteristica');//sin cambios
				exit;
			}
		} else{
            setcookie("msg","lim",time() + 2, "/");
			header('location:/admin/nuevo/caracteristica'); //limite
			exit;
		}
	}
}
...
<head>
  ...
  <title>Optimania - Nueva - Característica</title>
   <!-- General CSS Files -->
      ...
      <div class="main-content">
            ...
            <div class="col-md-12 col-lg-12 col-xl-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Agregar una característica nueva</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-8">
                <div class="card">
                    <div class="card-header">
                      <h4>Todas las características actuales</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                <?php $caracteristicasData = $db->getAllRecords('caracteristicas','*','ORDER BY id DESC');
                                      ...
                                      $y	=	'';
                                          foreach($caracteristicasData as $caracteristicas){
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="text-rigth">
                                                      <a href="/admin/editar/caracteristica?editId=<?php echo $caracteristicas['id']; ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
                                                      <a href="/admin/borrar/caracteristica?delId=<?php echo $caracteristicas['id']; ?>" onClick="return confirm('Estás seguro? Esto no se puede deshacer');" class="btn btn-icon btn-danger"><i class="fa fa-trash"></i></a>
                                                  </td>
                                              </tr>
