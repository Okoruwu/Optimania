        ...
        <div class="ps-portfolio">
            <div class="container">
                <div class="ps-portfolio__content">
                    <h3 style="color: gray; font-size: 30px" class="text-center"><a href="/lentes/vista/tamano">TAMAÑO</a> | <a href="/lentes/vista/color">COLOR</a> | <a style="color: #f18500;" href="/lentes/vista/material">METRIAL</a> | <a href="/lentes/vista/forma">FORMA</a> | <a href="/lentes/vista/marca">MARCA</a></h3>
                    <br>
                    <div class="ps-portfolio__tabs">
                        <ul class="nav nav-tabs text-center justify-content-center" id="productContentTabs" role="tablist">

                            <?php
                            $catData = $db->getAllRecords('carMaterial', '*', ' ORDER BY nombre ASC');
                            if (count($catData) > 0) {
                                $y    =    '';
