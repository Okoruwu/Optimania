        ...
        <div class="ps-portfolio">
            <div class="container">
                <div class="ps-portfolio__content">
                    <h3 style="color: gray; font-size: 30px" class="text-center"><a href="/lentes/contacto/tamano">TAMAÑO</a> | <a href="/lentes/contacto/color">COLOR</a> | <a href="/lentes/contacto/material">METRIAL</a> | <a style="color: #f18500;" href="/lentes/contacto/forma">FORMA</a> | <a href="/lentes/contacto/marca">MARCA</a></h3>
                    <br>
                                    ...
                                    <div class="tab-pane fade <?php echo $active; ?>" id="portfolio-all-<?php echo ($categoria['id']); ?>" role="tabpanel" aria-labelledby="portfolio-all-tab">
                                        <div class="ps-categogy--grid ps-categogy--detail">
                                            <div class="row">
                                                ...
                                                $productosData = $db->getAllRecords('productos', '*', 'AND categoria="2" AND carMarca="' . $categoria['id'] . '" ORDER BY nombre ASC');
