        ...
        <div class="ps-portfolio">
            <div class="container">
                <div class="ps-portfolio__content">
                    <h3 style="color: gray; font-size: 30px" class="text-center"><a href="/lentes/sol/tamano">TAMAÑO</a> | <a style="color: #f18500;" href="/lentes/sol/color">COLOR</a> | <a href="/lentes/sol/material">METRIAL</a> | <a href="/lentes/sol/forma">FORMA</a> | <a href="/lentes/sol/marca">MARCA</a></h3>
                    <br>
                                    ...
                                    <div class="tab-pane fade <?php echo $active; ?>" id="portfolio-all-<?php echo ($categoria['id']); ?>" role="tabpanel" aria-labelledby="portfolio-all-tab">
                                        <div class="ps-categogy--grid ps-categogy--detail">
                                            <div class="row">
                                                ...
                                                $productosData = $db->getAllRecords('productos', '*', 'AND categoria="1" ORDER BY nombre ASC');
