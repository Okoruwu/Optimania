                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                        ...
                                        <select name="categoria" class="form-control selectric" required>
                                            <option selected disabled>Selecciona una sub categoría</option>
                                            <?php
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Selecciona el estado del producto</label>
                                                    ...
                                                    foreach($statusData as $status){
                                                        ...
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="status" value="<?php echo ($status['id']);?>" class="selectgroup-input-radio"
                                                                <?php if (($status['id'])==1){ echo "checked"; }?>>
