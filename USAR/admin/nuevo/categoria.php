...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nombre==""){
		...
		$caractCount	=	$db->getQueryCount('categorias','id');
		if($caractCount[0]['total']<10000){
			...
			if($insert){
				...
				header('location:/admin/nuevo/categoria');//exito
				exit;
			}else{
			...
			header('location:/admin/nuevo/categoria'); //limite
			exit;
		}
	}
}
...
<head>
  ...
  <title>Optimania - Nueva - Categoría</title>
   <!-- General CSS Files -->
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                <?php $categoriaData = $db->getAllRecords('categorias','*','ORDER BY id DESC');
                                      ...
                                      $y	=	'';
                                          foreach($categoriaData as $categoria){
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="text-rigth">
                                                      <a href="/admin/editar/categoria?editId=<?php echo $categoria['id']; ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
                                                      <a href="/admin/borrar/categoria?delId=<?php echo $categoria['id']; ?>" onClick="return confirm('Estás seguro? Esto no se puede deshacer');" class="btn btn-icon btn-danger"><i class="fa fa-trash"></i></a>
                                                  </td>
                                              </tr>
