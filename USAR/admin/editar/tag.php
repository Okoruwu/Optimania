...
if (isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$tag  =  $db->getAllRecords('tags','*',' AND id="'.$_REQUEST['editId'].'"','LIMIT 1');
    
        if (empty($tag)) { //SI NO EXISTE ES QUE NO HAY UN ID VALIDO Y REDIRECCIONAMOS Y LANZAMOS ERROR
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nombre==""){
        ...
        if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	       ...
	       $update	=	$db->update('tags',$data,array('id'=>($_REQUEST['editId'])));
    
            if($update){
                setcookie("msg","tagup",time() + 2, "/");
                header('location:/admin/nuevo/tag'); //Exito en el cmabio
                exit;}
                else{
                    setcookie("msg","ups",time() + 2, "/");
...
<head>
  ...
  <title>Optimania - Editar - Tag</title>
  <!-- General CSS Files -->
    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
        ...
        <ul class="breadcrumb breadcrumb-style ">
            ...
            <li class="breadcrumb-item active">Editar un tag</li>
        </ul>
            ...
            <div class="col-md-12 col-lg-12 col-xl-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Estás editando: <?php echo ($tag['nombre']);?></h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label>Nombre</label>
                                    <input name="nombre" value="<?php echo ($tag['nombre']);?>" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="col-12">
