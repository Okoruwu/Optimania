<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
            ...
            <li class="dropdown"><a href="/admin/promociones" class="nav-link"><i data-feather="layers"></i><span>Promociones</span></a></li>
            ...
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="corner-right-down"></i><span>Filtros</span></a>
                <ul class="dropdown-menu">
                    <li><a href="/admin/nuevo/filtro/tamano">Tamaño</a></li>
                    <li><a href="/admin/nuevo/filtro/color">Color</a></li>
                    <li><a href="/admin/nuevo/filtro/material">Material</a></li>
                    <li><a href="/admin/nuevo/filtro/forma">Forma</a></li>
                    <li><a href="/admin/nuevo/filtro/marca">Marca</a></li>
                </ul>
            </li>
            <li class="dropdown">
